...
var imgDir = 'img/';
var start_img; // the mic image with a slash
var final_transcript; // the final text that was recognized
var recognition; // the webkitSpeechRecognition system
var current_style; // for showing a particular visual style of button
var afterRecordingCallback; // the callback function for after recording
var onClickStop; // the callback function for after the user stops holding down click
var onClickStopParam; // the parameters for the onClickStop callback
var recognizing = false; // whether the system is currently recognizing speech
var doneProcessing = false; // whether the system has completed processing
var doneRecording = false; // whether the system has completed recording
var currKey; // key to store information in session data
var sm; // sentence manager object
var recordBtnAllowed = true; // whether the user should be allowed to click record
